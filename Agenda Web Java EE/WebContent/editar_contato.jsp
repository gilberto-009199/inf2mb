...
<%
	...
	if (usuario == null) {
		...
		Contato contato = contatoDAO.getContato(Integer.parseInt(request.getParameter("id")));
%>
<!DOCTYPE html >
<html lang="pt">
<head>
		...
		<div class="row">
			...
			<div class="col-md-9">
				<div class="panel panel-primary">
					<div class="panel-heading">
						<h3 class="panel-title">
							<img src="imagens/contato24x24.png" style="margin-right: 9px;">Editar  contato
						</h3>
					</div>
					<div class="panel-body ">
								...
								<div class="form-row">
									...
									<div class="form-group col-md-3">
										<label for="txtDtNasc">Dt. Nasc.:</label> <input type="date"
											name="txtDtNasc" class="form-control" value="<%=contato.getDtNasc()%>">
									</div>
									<div class="form-group col-md-3">
								...
								<div class="form-row">
									<div class="form-group col-md-6">
										<label for="txtEmail">E-mail:</label> <input type="mail"
											name="txtEmail" class="form-control" value="<%=contato.getEmail()%>">
									</div>
									<div class="form-group col-md-3">
										<label for="txtTelefone">Telefone:</label> <input type="text" value="<%=contato.getTelefone() %>"
